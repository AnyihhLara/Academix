...
export const tables = readable([
    {name: 'Situaciones académicas', component: AcademicSituationForm, tableColumns: [{label: 'Nombre', key: 'name'}]},
    {
        ...
        tableColumns: [{label: 'Tipo', key: 'evaluationType'}, {
            label: 'Estudiante',
            key: 'student'
        }, {label: 'Asignatura', key: 'subject'}, {label: 'Fecha', key: 'evaluationDate'}]
    },
    {
        name: 'Tipos de evaluaciones',
        component: EvaluationTypeForm,
        tableColumns: [{label: 'Nombre', key: 'name'}, {label: 'Valor numérico', key: 'numericalValue'}]
    },
    {
        name: 'Estudiantes',
        component: StudentForm,
        tableColumns: [{label: 'Código', key: 'code'}, {label: 'Nombre', key: 'name'}, {
            label: 'Apellidos',
            key: 'lastname'
    ...
    },
    {
        ...
        tableColumns: [{label: 'Año', key: 'year'}, {label: 'Número', key: 'number'}]
    },
    {
        name: 'Asignaturas',
        component: SubjectForm,
        tableColumns: [{label: 'Nombre', key: 'name'}, {
            label: 'Cantidad de horas planificadas',
            key: 'plannedHours'
        }, {label: 'Año', key: 'year'}]
    },
    {name: 'Causas de baja', component: UnenrollmentReasonForm, tableColumns: [{label: 'Nombre', key: 'name'}]},
    {
        name: 'Años',
        component: YearForm,
        tableColumns: [{label: 'Año académico', key: 'academicYear'}, {label: 'Curso escolar', key: 'schoolYear'}]
    },
    {
        name: 'Usuarios',
        component: null,
        tableColumns: [{label: 'Nombre de usuario', key: 'username'}, {
            label: 'Contraseña',
            key: 'password'
        }, {label: 'Rol', key: 'role'}]
    },
